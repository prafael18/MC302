...
public class Main {
	...
	public static void main(String[] args) {
		...
		//multiplasPartidas(baralho1, baralho2, verbosidade, 100);
	}
	...
	private static void umaPartida(Baralho baralho1, Baralho baralho2, int verbosidade){
		...
		Motor partida = new Motor(baralho1, baralho2, Mao1, Mao2, jogA, jogB, verbosidade, "classe jogA", "classe jobB");
	...
	private static void multiplasPartidas(Baralho baralho1, Baralho baralho2, int verbosidade, int n){
		...
		for(int p = 0; p < 2; p++){
			for(int w = 0; w < n/2; w++){
				...
				Motor partida;
				if(moeda)
					partida = new Motor(deck1, deck2, Mao1, Mao2, jogA, jogB, verbosidade, "classe jogA", "classe jobB");
				else
					partida = new Motor(deck2, deck1, Mao2, Mao1, jogB, jogA, verbosidade, "classe jogA", "classe jobB");
